      ...
      <transition name="slide">
        <b-card>
            ...
            <b-col lg="6" class="my-1">
              <b-button size="sm" variant="warning" class="float-right">
                <download-excel
                  ...
                  :data="json_data"
                  :fields="json_fields"
                  worksheet="insurrances Info"
                  name="insurrancesInfo.xls"
                >
                  Export Data
                </download-excel>
              </b-button>
          ...
          >
            ...
            <template v-slot:actions="row">
              <div style="width: 180px">
                ...
                <b-button
                  size="sm"
                  @click="deleteInsurrance(row.item)"
                  class="mr-1"
                >
          ...
          <nav>
            <b-pagination
              size="sm"
              :total-rows="getRowCount(insurrances.results)"
              :per-page="perPage"
              v-model="currentPage"
              prev-text="Prev"
              next-text="Next"
