      ...
      <b-card>
        ...
        >
          ...
          <template v-slot:insurrance_employee_id="row">
            <div style="width: 180px">{{ row.value ? row.value : 'NaN' }}</div>
          </template>
          ...
          <template v-slot:actions="row">
            <div style="width: 180px">
              ...
              <b-button size="sm" @click="deleteLabourContract(row.item)" class="mr-1">
        ...
        <nav>
          <b-pagination size="sm" :total-rows="getRowCount(labourcontracts.results)" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
        </nav>
            ...
            <b-row>
              ...
              <b-col sm="4">
                <b-form-group label="Employee ID">
                  <b-form-input :value="infoModal.content.employee_id" readonly type="text"></b-form-input>
                </b-form-group>
              </b-col>
            </b-row>
            <b-row>
            ...
            <b-row>
              ...
              <b-col sm="6">
                <b-form-group label="Ngay Vao Lam:">
                  <b-form-input :value="infoModal.content.NgayVaoLam" readonly type="text"></b-form-input>
                </b-form-group>
              </b-col>
            </b-row>
          </b-form>
  ...
  data: () => {
    return {
      ...
      fields: [
        ...
        { key: 'position_id', label: 'Position ID', sortable: true, sortDirection: 'desc'},
        { key: 'office_id', label: 'Office ID', sortable: true, sortDirection: 'desc'},
        { key: 'salary_id', label: 'Salary Id', sortable: true, sortDirection: 'desc'},
        { key: 'literacy_id', label: 'Literacy ID', sortable: true, sortDirection: 'desc'},
        { key: 'insurrance_employee_id', label: 'Insurrance Employee ID', sortable: true, sortDirection: 'desc'},
        { key: 'NgayVaoLam', label: 'Start End', sortable: true, sortDirection: 'desc'},
