  ...
  <b-container fluid>
    <b-card>
        ...
        <b-col lg="12" class="my-1">
          <b-button size="sm" variant="warning" class="float-right">
            <download-excel
              ...
              :data="json_data"
              :fields="json_fields"
              worksheet="BangLuong Info"
              name="BangLuongInfo.xls"
            >
              Export Data
            </download-excel>
          </b-button>
      ...
      <nav>
        <b-pagination
          size="sm"
          :total-rows="getRowCount(bangluongs.results)"
          :per-page="perPage"
          v-model="currentPage"
          prev-text="Prev"
          next-text="Next"
...
export default {
  ...
  data() {
    return {
      json_fields: {
        ...
        aggregate_salary_id: "aggregate_salary_id",
        position_allowance: "position_allowance",
        insurrance_employee: "insurrance_employee",
        TienThuongPhat: "TienThuongPhat",
        months_salary: "months_salary",
        TongLuong: "TongLuong",
      ...
      fields: [
        ...
        {
          key: "insurrance_employee",
          label: "Insurrance Employee",
          sortable: true,
          class: "text-center"
        },
        {
          key: "TienThuongPhat",
          label: "TienThuongPhat",
          sortable: true,
          class: "text-center"
        },
        {
  ...
  mounted() {
    this.fetchBangLuongs();
    this.json_data = this.bangluongs.results;
  ...
  methods: {
    ...mapMutations("luongs", ["setEditMode"]),
    ...mapActions("luongs", ["fetchBangLuongs"]),
    getRowCount(items) {
      return items.length;
    },
    rowClicked(item) {
