<template>
  <b-container fluid>
    <b-card>
      ...
      <nav>
        <b-pagination size="sm" :total-rows="getRowCount(bangluongs.results)" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
      </nav>
  ...
  data() {
    return {
      fields: [
        ...
        { key: 'aggregate_salary_id', label: 'ID Bang Cong', sortable: true, class: 'text-center' },
        ...
        { key: 'TienThuongPhat', label: 'TienThuongPhat', sortable: true, class: 'text-center' },
        { key: 'months_salary', label: 'Months Salary', sortable: true, class: 'text-center' },
        { key: 'TongLuong', label: 'Sum Salary', sortable: true, class: 'text-center' },
