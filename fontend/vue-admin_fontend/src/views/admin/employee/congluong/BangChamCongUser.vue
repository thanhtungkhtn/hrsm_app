<template>
  <b-container fluid>
    <b-card>
      ...
      <nav>
        <b-pagination size="sm" :total-rows="getRowCount(bangchamcongs.results)" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
      </nav>
          ...
          <b-row>
            <b-col sm="12">
              <b-form-group label="Date:">
                <b-form-input :value="infoModal.content.date" @input="setCurrentCongDate" type="date"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col sm="4">
              <b-form-group label="Check in:">
                <b-form-input :value="infoModal.content.check_in" @input="setCurrentCongCheckIn" type="date"></b-form-input>
              </b-form-group>
            </b-col>
            <b-col sm="4">
              <b-form-group label="Check out:">
                <b-form-input :value="infoModal.content.check_out" @input="setCurrentCongCheckOut" type="date"></b-form-input>
              </b-form-group>
            </b-col>
            <b-col sm="4">
              <b-form-group label="Công Làm:">
                <b-form-input :value="infoModal.content.date_work" @input="setCurrentCongDateWork" type="number"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
        </b-form>
  ...
  data() {
    return {
      fields: [
        ...
        { key: 'check_in', label: 'Check-In', sortable: true, class: 'text-center' },
        { key: 'check_out', label: 'Check-Out', sortable: true, class: 'text-center' },
        { key: 'date_work', label: 'Work-Done Date', sortable: true, class: 'text-center' },
