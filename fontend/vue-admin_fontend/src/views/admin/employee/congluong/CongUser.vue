<template>
  <b-container fluid>
    <b-card>
      ...
      <nav>
        <b-pagination size="sm" :total-rows="getRowCount(bangcongs.results)" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
      </nav>
  ...
  data() {
    return {
      fields: [
        ...
        { key: 'date_work', label: 'Sum Work-Done Date', sortable: true, class: 'text-center' },
        { key: 'months_work', label: 'Work-Done Month', sortable: true, class: 'text-center' },
