      ...
      <b-card>
        ...
        >
          <template v-slot:actions="row">
            ...
            <b-button size="sm" @click="deletePermission(row.item)" class="mr-1">
        ...
        <nav>
          <b-pagination size="sm" :total-rows="getRowCount(permissions.results)" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
        </nav>
        ...
        <b-modal :id="infoModal.id" :title="infoModal.title" @hide="resetInfoModal">
          ...
          <b-form>
            ...
            <b-input class="col-md-12" id="inlineInput1" type="text" placeholder="Name"
