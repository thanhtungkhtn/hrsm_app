            ...
            <b-col lg="6" class="my-1">
              ...
              >
                <b-form-checkbox-group v-model="filterOn" class="mt-1">
                  ...
                  <b-form-checkbox value="native_place"
                    >Native Place</b-form-checkbox
                  >
          ...
          <b-row>
            <b-col cols="12" xl="12">
              <nav>
                <b-pagination
                  size="sm"
                  :total-rows="getRowCount(employees.results)"
                  :per-page="perPage"
                  v-model="currentPage"
                  prev-text="Prev"
                  next-text="Next"
              ...
              <b-row>
                ...
                <b-col sm="3">
                  <b-form-group label="Licensed">
                    <b-form-input
                      :value="infoModal.content.licensed"
                      readonly
                      type="text"
                    ></b-form-input>
                  </b-form-group>
              ...
              <b-row>
                ...
                <b-col sm="4">
                  <b-form-group label="Gender:">
                    <b-form-input
                      :value="infoModal.content.gender"
                      @input="setCurrentEmployeeGender"
                      type="text"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
                <b-col sm="4">
                  <b-form-group label="Day of Birth:">
                    <b-form-input
                      :value="infoModal.content.day_of_birth"
                      @input="setCurrentEmployeeDayOfBirth"
                      type="date"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
              ...
              <b-row>
                <b-col sm="6">
                  <b-form-group label="Phone Number:">
                    <b-form-input
                      :value="infoModal.content.phone_number"
                      @input="setCurrentEmployeePhoneNumber"
                      type="number"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
              ...
              <b-row>
                <b-col sm="5">
                  <b-form-group label="Identity Card Number:">
                    <b-form-input
                      :value="infoModal.content.identity_card_number"
                      @input="setCurrentEmployeeIdentityCardNumber"
                      type="number"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
                <b-col sm="3">
                  <b-form-group label="Native Place">
                    <b-form-input
                      :value="infoModal.content.native_place"
                      @input="setCurrentEmployeeNativePlace"
                      type="text"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
                <b-col sm="3">
                  <b-form-group label="Nationality">
                    <b-form-input
                      :value="infoModal.content.nationality"
                      @input="setCurrentEmployeeNationality"
                      type="text"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
              ...
              <b-row>
                <b-col sm="6">
                  <b-form-group label="Email">
                    <b-form-input
                      :value="infoModal.content.email"
                      @input="setCurrentEmployeeEmail"
                      type="email"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
                <b-col sm="6">
                  <b-form-group label="Address">
                    <b-form-input
                      ...
                      @input="setCurrentEmployeeAddress"
                      type="text"
                    ></b-form-input>
                  </b-form-group>
                </b-col>
              ...
              <b-row>
                ...
                <b-col sm="4">
                  <b-form-group label="Avarta">
                    <b-form-file
                      :value="infoModal.content.avatar"
                      @input="setCurrentEmployeeAvatar"
                    ></b-form-file>
                  </b-form-group>
                </b-col>
                <b-col sm="4">
                  <b-form-group label="Fingerprint Image">
                    <b-form-file
                      disabled
                      v-model="infoModal.content.fingerprint_image"
                      @input="setCurrentEmployeeFingerprintImage"
                    ></b-form-file>
                  </b-form-group>
                </b-col>
              </b-row>
...
export default {
  ...
  mounted() {
    ...
    this.fetchEmployees();
    this.json_data = this.employees.results;
