      ...
      <b-card>
        ...
        >
          <template v-slot:actions="row">
            ...
            <b-button size="sm" @click="deleteRelative(row.item)" class="mr-1">
        ...
        <nav>
          <b-pagination size="sm" :total-rows="getRowCount(relatives.results)" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>
        </nav>
...
export default {
  ...
  methods: {
    ...mapMutations('relatives', [
      'setEditMode',
    ]),
    ...mapActions('relatives', [
      'fetchRelatives',
      'deleteRelative',
    ]),
